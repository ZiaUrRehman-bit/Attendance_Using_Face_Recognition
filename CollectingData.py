import cv2
import FaceDetectionModule as fd  # face detection class
import numpy as np
import math
import time
'''
...
'''
# Making an object of class faceDetect
detectFace = fd.faceDetect()

offset = 10
imageSize = 300

folderName = "Data/shafique"
counter = 0

while True:
    Success, frame = cam.read()

    # find face and draw bounding box
    ...
    # now we crop the hand image
        if Success:
            ...
            imgCrop = frame[y - offset-30:y + h + offset, x - offset:x + w + offset]
